  ...
  return (
    <>
      ...
      <div class="fixed top-0 left-0 h-full z-50">
        <div
          class={`bg-white dark:bg-secondary min-h-screen border-r border-gray-200 dark:border-gray-700/30 shadow-lg dark:shadow-2xl pt-16 fixed text-gray-900 dark:text-white transition-all duration-300 ease-in-out transform ${
            isMenuOpen()
              ? "translate-x-0 w-72"
        ...
        >
          <div class="p-4">
            <div class="flex items-center space-x-3 px-2 py-2.5 mb-4 bg-[#EEF2FF] dark:bg-primary rounded-lg">
